...
const translations = {
  en: {
    ...
    'rules.tennis.chapter2.title': 'Chapter 2: Player Rankings & Rating',
    'rules.tennis.chapter2.rating.title': 'Rating Calculation Standards',
    'rules.tennis.chapter2.rating.content': 'Based on USTA/NTRP standards, combined with internal club competition results, unified rating determined by team captains.',
    ...
    'rules.tennis.chapter2.limits.wd': 'Women\'s Doubles: No strict limits, recommended 7.0–8.0 range, rating difference ≤ 0.5. If any team lacks sufficient female players, can request support from other teams.',
    'rules.tennis.chapter2.limits.xd1': 'Mixed Doubles 1: ≤ 8.0',
    'rules.tennis.chapter2.limits.xd2': 'Mixed Doubles 2: ≤ 7.5',
    'rules.tennis.chapter2.handicap.title': 'Handicap System',
    'rules.tennis.chapter2.handicap.rule1': 'Rating difference ≤ 0.5: Normal match',
    'rules.tennis.chapter2.handicap.rule2': 'Rating difference 0.6–1.0: Higher rated player gives 1 game',
    'rules.tennis.chapter2.handicap.rule3': 'Rating difference 1.1–1.5: Higher rated player gives 2 games',
    'rules.tennis.chapter2.handicap.rule4': 'Rating difference ≥ 1.6: Team captains negotiate lineup adjustment or declare no match',
    'rules.tennis.chapter2.gender.title': 'Gender Balance',
    'rules.tennis.chapter2.gender.content': 'We generally discourage men playing as women or women playing as men. In special circumstances where female players compete as men in men\'s doubles, their rating should be reduced by 0.5 for balance.',
    ...
    'rules.tennis.chapter4.title': 'Chapter 4: Playing Order',
    'rules.tennis.chapter4.rule1': 'If courts are available, both team captains can flexibly arrange the playing order.',
    'rules.tennis.chapter4.rule2': 'If courts are limited, recommended order: Men\'s Doubles 2 (or Men\'s Doubles 3) → Women\'s Doubles/Mixed Doubles 2 → Men\'s Doubles 1 → Mixed Doubles 1.',
    'rules.tennis.chapter4.rule3': 'For multi-round matches, both team captains must exchange lineup sheets in advance to avoid last-minute changes.',
    'rules.tennis.chapter5.title': 'Chapter 5: Substitutes & Injuries',
    'rules.tennis.chapter5.rule1': 'Each team may register several substitute players. Substitutes must be confirmed before the match and their rating must comply with the rules.',
    'rules.tennis.chapter5.rule2': 'Before the match starts, substitutes may be used to replace players.',
    'rules.tennis.chapter5.rule3': 'If a player is injured during the match, they must immediately withdraw and that match will be forfeited.',
    ...
    'rules.tennis.chapter6.details.score': 'Score announcement: During the match, the serving player announces the score',
  ...
  zh: {
    ...
    'rules.tennis.chapter2.rating.title': 'Rating 计算标准',
    'rules.tennis.chapter2.rating.content': '根据USTA/NTRP ，兼顾俱乐部内部比赛成绩，由队长群统一评定确定的等级分。',
    ...
    'rules.tennis.chapter2.limits.wd': '女双：不设严格限制，建议控制在 7.0–8.0 区间，双方 rating 差 ≤ 0.5。如果任何一队无足够女生，可以向其他队要求支持。',
    'rules.tennis.chapter2.limits.xd1': '混双1：≤ 8.0',
    'rules.tennis.chapter2.limits.xd2': '混双2：≤ 7.5',
    'rules.tennis.chapter2.handicap.title': '让分机制',
    'rules.tennis.chapter2.handicap.rule1': '双方 rating 差 ≤ 0.5，正常比赛。',
    'rules.tennis.chapter2.handicap.rule2': 'rating 差 0.6–1.0：高的一方让 1 局。',
    'rules.tennis.chapter2.handicap.rule3': 'rating 差 1.1–1.5：高的一方让 2 局。',
    'rules.tennis.chapter2.handicap.rule4': 'rating 差 ≥ 1.6：双方队长协商是否调整阵容或判定直接不匹配。',
    'rules.tennis.chapter2.gender.title': '性别平衡',
    'rules.tennis.chapter2.gender.content': '原则上我们不鼓励男当女打，或女当男打，特殊情况需要女选手当男生参赛时，若安排进入男双，rating 统一下调 0.5 作为平衡。',
    ...
    'rules.tennis.chapter4.title': '第四章 出场顺序',
    'rules.tennis.chapter4.rule1': '若场地充裕，双方队长可灵活安排出场顺序。',
    'rules.tennis.chapter4.rule2': '若场地有限，推荐顺序：男双2（或男双3） → 女双/混双2 → 男双1 → 混双1。',
    'rules.tennis.chapter4.rule3': '若为多轮比赛，双方队长需提前交换阵容表，避免临场突变。',
    'rules.tennis.chapter5.title': '第五章 替补与伤退',
    'rules.tennis.chapter5.rule1': '每队可报若干替补球员，替补须在赛前确认，rating需符合规则。',
    'rules.tennis.chapter5.rule2': '比赛未开始前，可由替补更换上场。',
    'rules.tennis.chapter5.rule3': '比赛中途若有队员受伤，需立即退赛，该场比赛判负。',
    ...
    'rules.tennis.chapter6.details.score': '比赛进行时，由发球队员报比分',
