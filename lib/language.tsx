...
const translations = {
  ...
  zh: {
    ...
    'rules.tennis.scoring.title': '计分系统',
    'rules.tennis.scoring.win': '胜：3分',
    'rules.tennis.scoring.draw': '平：1分',
    'rules.tennis.scoring.loss': '负：0分',
    'rules.tennis.format.title': '比赛形式',
    'rules.tennis.format.doubles': '男双',
    'rules.tennis.format.mixed': '混双',
    'rules.tennis.format.singles': '男单（短盘）',
    'rules.tennis.rules.title': '比赛规则',
    'rules.tennis.rules.itf': 'ITF标准规则',
    'rules.tennis.rules.pro8': 'Pro 8赛制',
    'rules.tennis.rules.flexible': '灵活规则调整',
